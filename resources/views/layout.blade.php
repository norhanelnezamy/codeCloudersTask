...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="{{URL('dashboard/vendor/datatables-plugins/dataTables.bootstrap.css')}}" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="{{URL('dashboard/vendor/datatables-responsive/dataTables.responsive.css')}}" rel="stylesheet">
